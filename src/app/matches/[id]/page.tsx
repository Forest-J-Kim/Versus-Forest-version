    ...
    useEffect(() => {
        const init = async () => {
            ...
            if (isOwner || matchData.status === 'SCHEDULED') {
                // Host Logic OR Scheduled Match: Fetch Applicants (For Scheduled, we need the accepted one)
                        ...
                        <div>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', maxHeight: '360px', overflowY: 'auto', paddingRight: '4px' }}>
                                {candidates.map(p => {
                                    ...
                                    const alreadyApplied = applicants.some(a => a.applicant_player_id === p.id && a.status !== 'REJECTED'); // Or just simple check
                                    ...
                                    return (
                                        <div
                                            ...
                                            style={{
                                                ...
                                                background: isSelected ? '#EFF6FF' : (alreadyApplied ? '#F9FAFB' : 'white'),
                                        ...
                                        >
                                            ...
                                            <div style={{ flex: 1 }}>
                                                <div style={{ fontWeight: 'bold', fontSize: '0.95rem', color: '#111827', display: 'flex', alignItems: 'center', gap: '6px' }}>
                                                    ...
                                                    {alreadyApplied && <span style={{ fontSize: '0.7rem', color: '#059669', background: '#D1FAE5', padding: '2px 6px', borderRadius: '4px' }}>신청됨</span>}
                                                </div>
        ...
        <div style={{
            ...
            {isPending && !isHost && (
                <div style={{
                    ...
                    padding: '8px', borderRadius: '8px', fontWeight: 'bold', fontSize: '0.9rem'
                }}>
                    신청 대기중
                </div>
            )}
