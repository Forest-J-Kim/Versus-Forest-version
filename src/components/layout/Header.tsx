...
import NotificationBell from "@/components/features/NotificationBell"; // 1. 벨 컴포넌트 추가
...
export default function Header() {
    ...
    // 2. 알림 페이지에서는 이 헤더를 숨깁니다 (페이지 자체 헤더 사용)
    if (isAuthPage || pathname === '/notifications') return null;
        ...
        <header className={styles.header}>
            {isHome ? (
                ...
                <div className={styles.subHeader}>
                    ...
                    {/* Add NotificationBell to sub-pages, pushed to right */}
